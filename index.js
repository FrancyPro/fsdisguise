...
> \`${prefix}setstaff\` - set staff roles`)
  ...
  if (command == prefix + 'send' || command == prefix + 'ticket') {
    ...
    .setLabel('Segnalo un bug')
    .setEmoji('889701910171488316')
    .setValue("men")
    .setDescription('Segnala un bug')
    let button2 = new MessageMenuOption()
    .setLabel('Ho bisogno di supporto generale')
    .setEmoji('❓')
    .setValue("op")
    .setDescription('Ho difficoltà su una cosa/report/etc')
    
    let button3 = new MessageMenuOption()
    .setLabel('Provino Staff member')
    .setEmoji('👨‍💼')
    .setValue("Help")
    .setDescription('Aggiungiti tra lo staff')  
    
    let button6 = new MessageMenuOption()
    .setLabel('Partnership')
    .setEmoji('890449051647098930')
    .setValue("shop2")
    .setDescription('Fai un Partnership su fusionmc')  
    
    let button4 = new MessageMenuOption()
    .setLabel('Report')
    .setEmoji('890449051647098930')
    .setValue("shop1")
    .setDescription('Se vuoi segnalare una persona')  
    
    let button5 = new MessageMenuOption()
    .setLabel('Aiuto store')
    .setEmoji('890451058307002399')
    .setValue("shop")
    .setDescription('Premi se hai difficoltà con lo store o vuoi pagare in un altro metodo')  
